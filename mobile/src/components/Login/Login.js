            ...
            <GradientBackground>
                <View style={styles.itemContainer}>
                    <View style={styles.titleContainer}>
                        <Text style={styles.titleText}>Розблокувати додаток</Text>
                    </View>
                    ...
                    <View style={styles.buttonOuterContainer}>
                        <TouchableOpacity onPress={this.openApp}>
                            <View style={styles.buttonInnerContainer}>
                                <Text style={styles.buttonText}>Відкрийте додаток</Text>
                            </View>
                        </TouchableOpacity>
                    </View>
                    <View style={styles.resetButtonOuterContainer}>
                        <TouchableOpacity onPress={this.resetApp}>
                            <View style={styles.resetButtonInnerContainer}>
                                <Text style={{ fontSize: 14, color: colors.black.one }}>Забули пароль? </Text>
                                <Text style={{ fontSize: 14, fontWeight: 'bold', color: colors.pink.one }}>Скинути додаток</Text>
                            </View>
                        </TouchableOpacity>
                    </View>
                </View>
